  ...
  return (
    <section className="flex flex-col items-center justify-center py-9 mx-auto w-full px-4 md:px-0">
      ...
      <div className="max-w-2xl pt-12">
        <SectionDescription>
          We help clients to design and develop future-proof, significant and secure digital
          products that are centered around users needs and fulfill client`s business goals.
        </SectionDescription>
      </div>
